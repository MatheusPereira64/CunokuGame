...
export function Avatar({ name, isBot, score = 0, isActive, className, position = "bottom", compact }: AvatarProps) {
  ...
  return (
    <div className={cn("flex flex-col items-center relative", compact ? "gap-1" : "gap-2", className)}>
      <div
        className={cn(
          "rounded-full border-4 flex items-center justify-center font-bold shadow-lg transition-all duration-300 relative bg-white",
